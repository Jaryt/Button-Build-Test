			...
			"errors": {
				"test-run": {
					"index.js": function (exports, module, require) {
						...
						var CurrentIframeNotFoundError = exports.CurrentIframeNotFoundError = function (_TestRunErrorBase44) {
						    _inherits(CurrentIframeNotFoundError, _TestRunErrorBase44);

						    function CurrentIframeNotFoundError() {
						        _classCallCheck(this, CurrentIframeNotFoundError);

						        return _possibleConstructorReturn(this, _TestRunErrorBase44.call(this, _types.TEST_RUN_ERRORS.currentIframeNotFoundError));
						    }

						    return CurrentIframeNotFoundError;
						}(TestRunErrorBase);

						var CurrentIframeIsInvisibleError = exports.CurrentIframeIsInvisibleError = function (_TestRunErrorBase45) {
						    _inherits(CurrentIframeIsInvisibleError, _TestRunErrorBase45);

						    function CurrentIframeIsInvisibleError() {
						        _classCallCheck(this, CurrentIframeIsInvisibleError);

						        return _possibleConstructorReturn(this, _TestRunErrorBase45.call(this, _types.TEST_RUN_ERRORS.currentIframeIsInvisibleError));
						    }
						...
						var NativeDialogNotHandledError = exports.NativeDialogNotHandledError = function (_TestRunErrorBase46) {
						    _inherits(NativeDialogNotHandledError, _TestRunErrorBase46);

						    function NativeDialogNotHandledError(dialogType, url) {
						        _classCallCheck(this, NativeDialogNotHandledError);

						        var _this64 = _possibleConstructorReturn(this, _TestRunErrorBase46.call(this, _types.TEST_RUN_ERRORS.nativeDialogNotHandledError));
						...
						var UncaughtErrorInNativeDialogHandler = exports.UncaughtErrorInNativeDialogHandler = function (_TestRunErrorBase47) {
						    _inherits(UncaughtErrorInNativeDialogHandler, _TestRunErrorBase47);

						    function UncaughtErrorInNativeDialogHandler(dialogType, errMsg, url) {
						        _classCallCheck(this, UncaughtErrorInNativeDialogHandler);

						        var _this65 = _possibleConstructorReturn(this, _TestRunErrorBase47.call(this, _types.TEST_RUN_ERRORS.uncaughtErrorInNativeDialogHandler));

						        _this65.dialogType = dialogType;
						        _this65.errMsg = errMsg;
						        _this65.pageUrl = url;
						        return _this65;
						    }
						...
						var SetNativeDialogHandlerCodeWrongTypeError = exports.SetNativeDialogHandlerCodeWrongTypeError = function (_TestRunErrorBase48) {
						    _inherits(SetNativeDialogHandlerCodeWrongTypeError, _TestRunErrorBase48);
						    ...
						    function SetNativeDialogHandlerCodeWrongTypeError(actualType) {
						        ...
						        var _this66 = _possibleConstructorReturn(this, _TestRunErrorBase48.call(this, _types.TEST_RUN_ERRORS.setNativeDialogHandlerCodeWrongTypeError));

						        _this66.actualType = actualType;
						        return _this66;
						    }
						...
						var RequestHookUnhandledError = exports.RequestHookUnhandledError = function (_TestRunErrorBase49) {
						    _inherits(RequestHookUnhandledError, _TestRunErrorBase49);

						    function RequestHookUnhandledError(err, hookClassName, methodName) {
						        _classCallCheck(this, RequestHookUnhandledError);

						        var _this67 = _possibleConstructorReturn(this, _TestRunErrorBase49.call(this, _types.TEST_RUN_ERRORS.requestHookUnhandledError));

						        _this67.errMsg = String(err);
						...
						var RequestHookNotImplementedMethodError = exports.RequestHookNotImplementedMethodError = function (_TestRunErrorBase50) {
						    _inherits(RequestHookNotImplementedMethodError, _TestRunErrorBase50);
						    ...
						    function RequestHookNotImplementedMethodError(methodName, hookClassName) {
						        ...
						        var _this68 = _possibleConstructorReturn(this, _TestRunErrorBase50.call(this, _types.TEST_RUN_ERRORS.requestHookNotImplementedError));

						        _this68.methodName = methodName;
						        _this68.hookClassName = hookClassName;
						        return _this68;
						    }
